...
#
# TODO: remove the private-repo usage block below once the repo is public.
# Usage (public repo, once flipped):
...
# Prefer gh: works for both private and public repos with the user's cached
# auth. Fall back to unauthenticated curl for the public-repo phase.
